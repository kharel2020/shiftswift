...
**ShiftSwift HR** is a trading name of **Datasoftware Analytics Ltd** (Company No. **14568900**), registered in England & Wales, 235 Charlbury Road, Nottingham, NG8 1NF.

- **Product support:** support@shiftswifthr.co.uk  
- **Privacy & legal:** legal@datasoftwareanalytics.co.uk

For HR data processed on behalf of your employer, your employer is usually the **data controller** and Datasoftware Analytics Ltd acts as a **data processor**. See our [Data Processing Addendum](./hr_dpa_outline.md).
...
| Context | Examples | Purpose |
|---------|----------|---------|
| Website | IP address, browser type, pages viewed | Security, analytics, improve the site |
...
- HR data is segregated from unrelated commerce systems (see DPA)

Details of technical measures are in our [Cyber Essentials readiness notes](./cyber_essentials_readiness.md).
