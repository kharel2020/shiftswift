...
(function () {
  ...
  const FALLBACK_PLATFORM_PLANS = [
    ...
    },
    {
      ...
      max_employees: 50,
      price_gbp_ex_vat: 79,
      price_gbp_inc_vat: 94.8,
      features: ["Everything in Medium", "Priority support", "Multi-role RBAC"],
    },
    {
      id: "site_starter_annual",
      name: "Starter — annual",
      description: "Up to 10 employees, billed annually (2 months free).",
      billing_interval: "year",
      max_employees: 10,
      price_gbp_ex_vat: 189.5,
      price_gbp_inc_vat: 227.4,
      features: ["Core HR", "Rota basics", "Sponsor compliance module"],
    },
  ];
  ...
  const FALLBACK_PAYROLL_PLANS = [
    ...
    },
    {
      ...
      price_gbp_ex_vat: 49,
      price_gbp_inc_vat: 58.8,
      features: ["Everything in Payroll Starter", "Multi-rate pay rules", "Tips & tronc export"],
    },
    {
